<ul class="list-unstyled">
    ...
    <li class="mb-3 text-center">
        ...
        @if($post->user->profile_image)
            <img class="rounded-circle img-fluid" src="{{ $post->user->profile_image }}" alt="ユーザの画像" style="max-width: 50px; max-height: 50px;">
        @else
            <img class="rounded-circle img-fluid" src="{{ asset('storage/default-profile-image.png') }}" alt="デフォルトのプロフィール画像" style="max-width: 50px; max-height: 50px;">
        @endif            
