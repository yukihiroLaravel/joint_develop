    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('search.search') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="param1" name="param1" placeholder="キーワードで検索">
            </div>
            
            <div class="form-group">
                <label for="param2">ユーザ :</label>
                <input type="text" class="form-control" id="param2" name="param2" placeholder="ユーザ名で検索">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="param4" name="param4" >
            </div>
