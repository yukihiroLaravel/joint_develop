<header class="mb-5">
    <nav class="navbar navbar-expand-sm  navbar-light bg-warning">
        <a class="navbar-brand" href="/" style="color: black;">みんなの大喜利「GiriGiri」</a>
        ...
        <div class="collapse navbar-collapse" id="nav-bar">
            ...
            <ul class="navbar-nav">
                @if (Auth::check())
                    <li class="nav-item"><a href="{{ route('top') }}" class="nav-link text-dark">お題</a></li>
                    <li class="nav-item"><a href="{{ route('comment.index') }}" class="nav-link text-dark">ボケ</a></li>
