<ul class="nav nav-tabs nav-justified mb-3">
    ...
    <li class="nav-item nav-link"><a href="{{ route('favorites', $user->id) }}" class="{{ Request::is('users/'. $user->id. 'favorites'. $user->id) ? 'active' : '' }}">いいね<span class="ml-2 badge badge-success">{{ $user->favorites()->count() }}</span></a></li>
</ul>