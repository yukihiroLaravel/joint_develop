...
@section('content')
    ...
    <h5 class="text-center mb-3"><img src="{{ asset('img/tamori.png') }}" width="50" height="50" style="margin-top: -5px; margin-right: 5px;" alt="Tamori">な気分の話題について{{ config('app.contentMaxLength') }}字以内で会話しよう！</h5>
    @auth
