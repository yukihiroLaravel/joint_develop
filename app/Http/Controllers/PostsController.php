...
class PostsController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('welcome', ['posts' => $posts, 'user' => $user, 'search' => $search]);  //welcome ビューにデータを渡して、ビューを表示、$posts変数には検索結果が格納され、$search 変数にはユーザーが入力したキーワードが格納。ビュー内でこれらの変数を使用して結果を表示
    }
